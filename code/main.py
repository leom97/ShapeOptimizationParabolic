...
# %% Save results
pickles_path = "/home/leonardo_mutti/PycharmProjects/masters_thesis/code/results/"
pickle_name = "scipy_optimization_results"
...
file = XDMFFile(pickles_path)
infile = XDMFFile(pickles_path + "/result_file.xdmf")
...
# %% Todo
# 1) implement smoothing (bound on derivatives, could be interfaced with minimize)
...
# 7) implement automatic saving of results and simulation parameters
