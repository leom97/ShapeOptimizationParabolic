...
class CustomBFGS(OptimisationAlgorithm):
    """
    ...
    def __init__(self, problem, initial_point=None, options={}, hooks={}, **args):
        ...
        if self.options["Hinit"] == "default":
            ...
            Hinit = LinearOperator(
                lambda v: v.primal().__class__(v.data))  # FIXME: Find a better way how to get the PrimalVector class
        else:
